    ...
    <div className="min-h-screen  flex flex-col items-center ">
      ...
      <div className="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2 xl:w-1/4 mt-10">
        <form action="form" onSubmit={(e) => handleRegister(e)}>
          ...
          <button
            className="bg-gradient-to-r from-[#9d0825] to-[#6c012e] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 w-full focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            type="submit"
          >
            REGISTER
          </button>
